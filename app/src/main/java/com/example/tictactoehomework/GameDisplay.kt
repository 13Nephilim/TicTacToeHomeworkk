...
class GameDisplay : AppCompatActivity(), View.OnClickListener {
    ...
    private fun restartGame() {
        ...
        btn1.backgroundTintList = getColorStateList(R.color.white)
        btn2.backgroundTintList = getColorStateList(R.color.white)
        btn3.backgroundTintList = getColorStateList(R.color.white)
        btn4.backgroundTintList = getColorStateList(R.color.white)
        btn5.backgroundTintList = getColorStateList(R.color.white)
        btn6.backgroundTintList = getColorStateList(R.color.white)
        btn7.backgroundTintList = getColorStateList(R.color.white)
        btn8.backgroundTintList = getColorStateList(R.color.white)
        btn9.backgroundTintList = getColorStateList(R.color.white)
